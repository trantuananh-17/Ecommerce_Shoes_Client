...
const ToastSuccess: React.FC<Props> = ({ message, duration = 2000 }) => {
  ...
  return (
    <div className="fixed top-16 right-6 z-50">
      <div
        className={`relative flex items-center gap-3 px-4 py-3 pr-10 rounded-2xl bg-green-500 text-white shadow-lg transition-all duration-500 transform
