...
import { fetchClosureAPI } from "../../../services/closure.service";
...
const Closure: React.FC<Props> = React.memo(({ onClose }) => {
  ...
  const [categories, setCategories] = useState<ClosureItem[]>([]);
  ...
  const fetchClosures = useCallback(async () => {
    const response = await fetchClosureAPI(pagination.page, pagination.limit);
